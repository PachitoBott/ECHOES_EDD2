...
class Game:
    ...
    def __init__(
        ...
        *,
        ...
        # --- Paneles de jugadores (stacked vertically on left side, larger and repositioned) ---
        ...
        self.hud_panel_p1 = HUDPanel(
            ...
            custom_y=180  # Higher than before
        )
        # P2 offset Y: P1 Y (180) + P1 height (200) + spacing (10) = 390
